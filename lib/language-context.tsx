...
const translations = {
  en: {
    ...
    // Hero Section
    "hero.badge": "AI systems for real operations",
    ...
    "hero.cta2": "See Demo",
    "hero.benefit1": "Governed operation",
    "hero.benefit2": "Scoped deployment",
    "hero.benefit3": "Production Ready",
    "hero.stat1_label": "System focus",
    "hero.stat1_value": "AI + workflows",
    "hero.stat2_label": "Control model",
    "hero.stat2_value": "Human review",
    "hero.stat3_label": "Evidence",
    "hero.stat3_value": "Traceable",
  ...
  es: {
    ...
    // Hero Section
    "hero.badge": "Sistemas de IA para operaciones reales",
    ...
    "hero.cta1": "Comenzar",
    "hero.cta2": "Ver Demo",
    "hero.benefit1": "Operación gobernada",
    "hero.benefit2": "Despliegue acotado",
    "hero.benefit3": "Listo para Producción",
    "hero.stat1_label": "Foco del sistema",
    "hero.stat1_value": "IA + flujos",
    "hero.stat2_label": "Modelo de control",
    "hero.stat2_value": "Revisión humana",
    "hero.stat3_label": "Evidencia",
    "hero.stat3_value": "Trazable",
