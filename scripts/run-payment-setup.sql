-- Execute the payment tables setup with proper error handling
...
DROP POLICY IF EXISTS "Users can view own agent purchases" ON agent_purchases;
DROP POLICY IF EXISTS "Users can insert own agent purchases" ON agent_purchases;
DROP POLICY IF EXISTS "Users can update own agent purchases" ON agent_purchases;
...
DROP TRIGGER IF EXISTS update_agent_purchases_updated_at ON agent_purchases;
