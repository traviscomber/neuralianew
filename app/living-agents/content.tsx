  ...
  const archetypes = [
    {
      ...
      description: 'Entiende contexto, detecta patrones, captura insights de datos. Ve lo que otros pierden. Inteligencia desde la observación.',
    ...
    },
    {
      ...
      description: 'Evalúa opciones, simula escenarios, sugiere estrategias predictivas. Toma decisiones informadas bajo incertidumbre.',
      traits: ['Evaluador', 'Simulador', 'Estratégico'],
      image: '/images/living-agents/strategist.svg',
    },
    {
      title: 'El Arquitecto',
      role: 'Execution Engine',
      description: 'Construye soluciones, genera contenido, automatiza procesos. Convierte ideas en realidad operativa.',
      traits: ['Constructor', 'Generador', 'Automatizador'],
      image: '/images/living-agents/architect.svg',
    },
    {
      title: 'El Guardián',
      role: 'Quality Control',
      description: 'Valida resultados, asegura consistencia, dispara alertas. Protege la integridad del sistema.',
      traits: ['Validador', 'Protector', 'Monitoreador'],
