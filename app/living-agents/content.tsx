  ...
  const archetypes = [
    {
      title: 'El Centinela',
      role: 'Tu Detective',
      shortDesc: 'Mi observador',
      description: 'Valida mercado, detecta oportunidades, analiza competencia. Tu primer guardián contra decisiones equivocadas.',
      traits: ['Investigador', 'Analítico', 'Crítico'],
      image: '/images/living-agents/sentinel.svg',
    },
    {
      title: 'El Estratega',
      role: 'Tu CEO',
      shortDesc: 'Mi estratega',
      description: 'Diseña modelo de negocio, pricing, go-to-market. Toma decisiones complejas bajo incertidumbre. No necesitas MBA.',
      traits: ['Visionario', 'Decisor', 'Estratégico'],
      image: '/images/living-agents/strategist.svg',
    },
    {
      title: 'El Arquitecto',
      role: 'Tu CTO',
      shortDesc: 'Mi constructor',
      description: 'Desarrolla producto, diseña infraestructura, automatiza. Tu equipo técnico sin nómina. Código production-ready.',
      traits: ['Ingeniero', 'Innovador', 'Automatizador'],
      image: '/images/living-agents/architect.svg',
    },
    {
      title: 'El Guardián',
      role: 'Tu COO',
      shortDesc: 'Mi protector',
      description: 'Monitorea métricas, alertas automáticas, recomendaciones. Siempre vigilando que tu negocio funcione.',
      traits: ['Vigilante', 'Protector', 'Optimizador'],
      image: '/images/living-agents/guardian.svg',
    },
  ]
