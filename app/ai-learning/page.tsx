          ...
          <CardContent>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                This process runs continuously in the background, ensuring that your AI assistant becomes smarter and
                more effective with every interaction. The more you use the system, the better it becomes at
                understanding your specific needs and environment.
              </p>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="p-4 bg-white rounded-lg border border-orange-200 hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-muted-foreground">
                  Continuously evaluates and minimizes risks associated with recommendations to prevent alert fatigue
                  and system issues.
                </p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-200">
          ...
          <CardContent>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Join the next generation of performance monitoring with AI that learns, adapts, and continuously
                improves to provide the most relevant and effective recommendations for your unique environment.
              </p>
