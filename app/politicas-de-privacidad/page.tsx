        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              En Neuralia, respetamos su privacidad y nos comprometemos a proteger sus datos personales. Esta Política
              de Privacidad explica cómo recopilamos, utilizamos, almacenamos y protegemos su información cuando utiliza
              nuestros servicios.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">2.3 Datos de Conversación</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">Procesamos sus datos personales basándose en:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">No vendemos sus datos personales. Podemos compartir información con:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Sus Derechos</h2>
            <p className="text-gray-700 mb-4">Dependiendo de su ubicación, puede tener los siguientes derechos:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              con al menos 30 días de anticipación a través de nuestro sitio web o por correo electrónico.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Contacto y Quejas</h2>
            <p className="text-gray-700 mb-4">
