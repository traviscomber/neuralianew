    ...
    <main className="min-h-screen bg-background">
      <section className="min-h-screen bg-gradient-to-b from-background via-background to-muted/30 flex items-center justify-center px-4 pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto w-full text-center relative z-10">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">{isES ? "Automatización para empresas de La Serena. Turismo, retail, minería. Soporte local, ROI garantizado en 6 meses." : "Automation for La Serena businesses. Tourism, retail, mining. Local support, 6-month ROI guarantee."}</p>
