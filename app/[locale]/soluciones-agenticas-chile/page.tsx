...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    locale,
    path: '/soluciones-agenticas-chile',
    title: isES
      ? 'Soluciones Agenticas para Chile | Arquitectura de Agentes IA'
      : 'Agentic Solutions for Chile | AI Agent Architecture',
    description: isES
      ? 'Arquitectura agentica especializada para empresas chilenas. Sistemas conversacionales inteligentes, orquestación multi-agente y diseño responsable.'
      : 'Specialized agentic architecture for Chilean companies: intelligent conversational systems, multi-agent orchestration and responsible design.',
  })
}
