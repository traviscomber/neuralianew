    ...
    <main className="min-h-screen bg-background">
      <section className="min-h-screen bg-gradient-to-b from-background via-background to-muted/30 flex items-center justify-center px-4 pt-32 pb-16">
        <div className="max-w-5xl mx-auto w-full text-center">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight text-foreground text-balance">{isES ? "Agentes de IA para Rancagua" : "AI Agents for Rancagua"}</h1>
          <p className="text-lg sm:text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">{isES ? "Para Rancagua: minería, manufactura, retail. Agentes inteligentes que optimizan operaciones y generan ROI rápido." : "For Rancagua: mining, manufacturing, retail. Intelligent agents that optimize operations and generate quick ROI."}</p>
