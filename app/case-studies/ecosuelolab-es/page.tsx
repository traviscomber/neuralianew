...
export const metadata: Metadata = {
  title: "Caso de Estudio Ecosuelolab | N3uralia - Monitoreo Agrícola Satelital + Agentes IA",
  description:
  ...
  keywords:
    "ecosuelolab, agricultura, monitoreo suelo, agentes IA, IrriWatch, integración API, N3uralia, caso de estudio, Chile",
  alternates: {
    canonical: "https://n3uralia.com/es/case-studies/ecosuelolab",
    languages: {
      en: "https://n3uralia.com/en/case-studies/ecosuelolab",
      "es-CL": "https://n3uralia.com/es/case-studies/ecosuelolab",
    },
  },
  openGraph: {
...
export default function EcosuelolabCaseStudyES() {
  return (
    <>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/es/capabilities#conversational"
