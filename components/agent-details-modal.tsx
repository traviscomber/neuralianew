          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-gray-600">{agent.reviews} reviews</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 text-center">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="font-semibold text-sm text-gray-700">Parameters</div>
                      <div className="text-lg font-bold">{agent.neuralSpecs.parameters}</div>
                    </div>
                    <div>
                      <div className="font-semibold text-sm text-gray-700">Processing Speed</div>
                      <div className="text-lg font-bold">{agent.neuralSpecs.processingSpeed}</div>
                    </div>
                  </div>
                  <Separator />
                  <div>
                    <div className="font-semibold text-sm text-gray-700 mb-2">Architecture</div>
                    <div className="text-sm">{agent.neuralSpecs.architecture}</div>
                  </div>
                  <div>
                    <div className="font-semibold text-sm text-gray-700 mb-2">Training Data</div>
          ...
          <Card className="border-2 border-blue-200 bg-blue-50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-3xl font-bold text-gray-900">${agent.price}</div>
                  <div className="text-sm text-gray-600">per month</div>
                  <Badge className="mt-2 bg-green-100 text-green-700">5-Day Free Trial</Badge>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-gray-600 text-center">No credit card required • Cancel anytime</div>
                </div>
              </div>
            </CardContent>
          </Card>
