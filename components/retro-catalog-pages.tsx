...
const projectData: Record<Locale, {sector:string;problem:string;system:string;value:string;tags:string[]}[]> = {
  es: [
    { sector:'Compliance Documental para Transporte', problem:'Flotas y contratistas de transporte en Chile pierden dinero y detienen operaciones por documentos vencidos — revisión técnica, permiso de circulación, SOAP — gestionados en Excel, WhatsApp y carpetas sin alertas.', system:'DocuFleet (cleaner2.vercel.app): capa inteligente de cumplimiento documental para LABBE. IA que clasifica documentos automáticamente, extrae fechas de vencimiento, dispara alertas 30/15/5 días antes y genera carpetas documentales listas para mandantes e inspecciones.', value:'Nunca más un vehículo detenido por documentos vencidos — 86% de cobertura documental, trazabilidad completa de flota y evidencia auditab lista en segundos.', tags:['DocuFleet','IA','Vencimientos','Flota','Transporte','Cumplimiento'] },
    { sector:'Seguridad Operativa con IA', problem:'Empresas con cámaras, sensores y controles de acceso instalados pero desconectados — mucho ruido, sin visibilidad real ni respuesta a tiempo.', system:'seguria.tech: plataforma integral de seguridad operativa que se conecta a la infraestructura existente sin reemplazarla. Capa de IA sobre lo instalado para Campos Inteligentes (perímetros, bodegas, zonas remotas), Propiedades Inteligentes y Hotelería — con dashboard de sitios, eventos y respuesta en tiempo real.', value:'La seguridad existente se convierte en operación inteligente: menos falsas alarmas, alertas con contexto y evidencia lista para decidir sin perseguir pantallas.', tags:['IA','Seguridad','Cámaras','Sensores','Campos','Hotelería'] },
  ...
  en: [
    { sector:'Document Compliance for Transport', problem:'Chilean transport fleets and contractors lose money and halt operations due to expired documents — vehicle inspection, circulation permits, SOAP — managed in Excel, WhatsApp and folders with no alerts.', system:'DocuFleet (cleaner2.vercel.app): intelligent document compliance layer for LABBE. AI auto-classifies documents, extracts expiry dates, fires alerts 30/15/5 days before expiry, and generates audit-ready document folders for clients and inspections.', value:'No more vehicles stopped for expired documents — 86% document coverage, full fleet traceability and auditable evidence ready in seconds.', tags:['DocuFleet','AI','Expiry','Fleet','Transport','Compliance'] },
    { sector:'AI-Powered Operational Security', problem:'Companies with cameras, sensors and access controls installed but disconnected — too much noise, no real visibility and slow response.', system:'seguria.tech: integral operational security platform that connects to existing infrastructure without replacing it. AI layer over what is already installed, covering Smart Fields (perimeters, warehouses, remote zones), Smart Properties and Smart Hospitality — with a real-time dashboard for sites, events and response.', value:'Existing security becomes an intelligent operation: fewer false alarms, context-rich alerts and evidence ready to act on — without chasing screens.', tags:['AI','Security','Cameras','Sensors','Fields','Hospitality'] },
