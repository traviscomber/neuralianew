...
const projectData: Record<Locale, {sector:string;problem:string;system:string;value:string;tags:string[]}[]> = {
  es: [
    ...
    { sector:'Operaciones Mineras con IA', problem:'Operaciones mineras con información fragmentada en faena: sensores aislados, órdenes manuales, bodega ciega, HSE tardío y auditoría imposible.', system:'Plataforma operacional minera completa: producción, mantención, bodega, HSE, documentos y gerencia en un flujo trazable desde terreno hasta dirección. Flujo integrado: Alerta → OT automática → Repuesto → HSE → Evidencia → KPI.', value:'+15% disponibilidad de equipos, -40% MTTR, -25% costos de mantención, 100% trazabilidad auditada — decisiones desde datos reales, no desde reportes manuales.', tags:['Minería','Motil','KPIs','Mantención','HSE','Trazabilidad'] },
  ...
  en: [
    ...
    { sector:'Mining Operations with AI', problem:'Mining operations with fragmented field information: isolated sensors, manual work orders, blind warehouse, delayed HSE and impossible audits.', system:'Full mining operational platform: production, maintenance, warehouse, HSE, documents and management in a traceable flow from field to boardroom. Integrated flow: Alert → Auto work order → Spare part → HSE → Evidence → KPI.', value:'+15% equipment availability, -40% MTTR, -25% maintenance costs, 100% auditable traceability — decisions from real data, not manual reports.', tags:['Mining','Motil','KPIs','Maintenance','HSE','Traceability'] },
...
const productData: Record<Locale, {desc:string;forWhom:string;modules:string[];status:string}[]> = {
  es: [
    ...
    { desc:'Mejora y restauración de imágenes con IA construida específicamente para el contexto visual del Sudeste Asiático. Los upscalers genéricos alteran tonos de piel, facciones, textiles y ornamentos culturales — Clar1ty preserva exactamente eso. Upscale de retratos, restauración de fotos de archivo, mejora de assets creativos para uso profesional o impresión. Upload → preset → download.', forWhom:'Fotógrafos, creadores, archivos de patrimonio, instituciones culturales y cualquiera que trabaje con imágenes de herencia o retratos asiáticos donde los detalles culturales importan.', modules:['Upscale de retratos con identidad preservada','Restauración de fotos de archivo','Presets por tipo de imagen','Comparación antes/después','Modo profesional & API','Preparado para impresión'], status:'Disponible — prueba gratis' },
    { desc:'Plataforma de 21 agentes de IA especializados — no es IA genérica, cada agente es un experto entrenado en su dominio. 5 categorías: Marketing, Desarrollo, Diseño, Análisis y Blockchain. Incluye Coach IA, Transporte IA (permisos y certificados chilenos), Bienes Raíces IA, Hospitalidad IA, Agro IA y Estudio RLHF. Sin código. Setup en 3 días. Resultados medibles desde el día 1. 85% menos errores operacionales, 42% de eficiencia ganada, 10x velocidad de procesamiento.', forWhom:'Empresas que necesitan automatizar operaciones críticas sin equipo técnico — desde una inmobiliaria que quiere gestionar clientes con IA hasta un operador logístico que necesita cumplimiento documental automático.', modules:['21 agentes especializados','Marketing & contenido','Desarrollo & código','Diseño & creatividad','Análisis & datos','Blockchain','Transporte IA','Coach IA','Bienes Raíces IA'], status:'Disponible — comenzar gratis' },
  ],
  en: [
    ...
    { desc:'AI image enhancement and restoration built specifically for Southeast Asian visual context. Generic upscalers alter skin tones, facial structure, textiles and cultural ornaments — Clar1ty preserves exactly that. Portrait upscaling, heritage photo restoration, creative asset enhancement for professional use or print. Upload → preset → download.', forWhom:'Photographers, creators, heritage archives, cultural institutions and anyone working with Asian portraits or heritage images where cultural detail must be preserved.', modules:['Portrait upscaling with identity preserved','Heritage photo restoration','Presets by image type','Before/after comparison','Professional mode & API','Print-ready output'], status:'Available — try free' },
    { desc:'Platform of 21 specialized AI agents — not generic AI, each agent is an expert trained in its domain. 5 categories: Marketing, Development, Design, Analysis and Blockchain. Includes AI Coach, Transport AI (Chilean permits and certificates), Real Estate AI, Hospitality AI, Agro AI and RLHF Studio. No code. 3-day setup. Measurable results from day 1. 85% fewer operational errors, 42% efficiency gain, 10x processing speed.', forWhom:'Companies needing to automate critical operations without a technical team — from a real estate firm wanting AI-powered client management to a logistics operator needing automatic document compliance.', modules:['21 specialized agents','Marketing & content','Development & code','Design & creativity','Analysis & data','Blockchain','Transport AI','AI Coach','Real Estate AI'], status:'Available — start free' },
  ],
}
