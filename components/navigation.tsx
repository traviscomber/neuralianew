...
export default function Navigation({ locale = 'es' }: NavigationProps) {
  ...
  const items: NavItem[] = [
    ...
    { href: href('#how-we-work'), label: isES ? 'Método' : 'Method' },
  ...
  return (
    <nav className='fixed inset-x-0 top-0 z-50 border-b border-[#dfe8e5] bg-[#fbfbfa]/95 backdrop-blur-md'>
      <div className='mx-auto grid h-[4.5rem] max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-5 px-5 sm:px-8 lg:px-10'>
