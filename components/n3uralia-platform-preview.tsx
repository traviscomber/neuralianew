  ...
  en: [
    {
      ...
      metric: 'CONTROL',
      metricLabel: 'compliance visibility',
    ...
    },
    {
      ...
      metric: 'SEARCH',
      metricLabel: 'records with context',
    ...
    },
    {
      ...
      metric: 'BASELINE',
      metricLabel: 'measured before impact',
    ...
    },
    {
      ...
      metric: 'TRACE',
      metricLabel: 'shared operating layer',
  ...
  es: [
    {
      ...
      image: '/n3uralia-brand/operational-dashboard.png',
      metric: 'CONTROL',
      metricLabel: 'visibilidad de cumplimiento',
    ...
    },
    {
      ...
      image: '/n3uralia-brand/client-repository.png',
      metric: 'BÚSQUEDA',
      metricLabel: 'registros con contexto',
    ...
    },
    {
      ...
      image: '/n3uralia-brand/food-plant.png',
      metric: 'BASELINE',
      metricLabel: 'impacto medido desde base real',
    ...
    },
    {
      ...
      image: '/n3uralia-brand/mining-platform.png',
      metric: 'TRAZA',
      metricLabel: 'capa operativa compartida',
      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.78fr_1.22fr]">
        ...
        <div className="border border-[#1e3431] bg-[#102624] p-4 shadow-[0_35px_120px_-80px_#000]">
          ...
          <div className="grid gap-6 border-x border-b border-white/10 bg-[#071211] p-6 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <Link href={`/${locale}/${locale === "es" ? "soluciones" : "solutions"}`} className="inline-flex items-center justify-center gap-2 bg-[#8fb2aa] px-5 py-3 text-sm font-semibold text-[#06100f] transition-colors hover:bg-[#d9e3e0]">
              {text.cta}
