    ...
    <section className="min-h-screen bg-white flex items-center justify-center pt-20">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <h1 className="text-7xl md:text-8xl font-bold tracking-tight mb-8 leading-tight">
          {t.orchestration}
          <br />
          <span className="text-primary/70">{t.simplified}</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Button size="lg" className="px-8 bg-primary text-white hover:bg-primary/90 rounded-lg font-semibold gap-2">
          ...
          <Button
            size="lg"
            variant="outline"
            className="px-8 border-primary text-primary hover:bg-primary/5 rounded-lg font-semibold bg-transparent"
          >
