        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of developers and businesses already using Neuralia to create intelligent, scalable AI
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-gray-600 text-gray-300 hover:bg-gray-800 px-8 py-4 bg-transparent"
              >
                Schedule Demo
              </Button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              The most advanced AI agent platform for building, deploying, and scaling intelligent conversational
              experiences.
            </p>
