          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
            <div>
              ...
              <div className="mt-5 inline-flex rounded-full border border-[#d8e5e2] bg-[#eef5f2] px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#789b96]">
                {isES ? "Santiago, Chile · LATAM" : "Santiago, Chile · LATAM"}
              </div>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-[#d8e5e2] bg-[#fbfbfa] p-5">
              ...
              <ul className="mt-5 space-y-3 text-sm text-[#65706d]">
                <li>
                  <a href="mailto:info@n3uralia.com" className="transition-colors hover:text-[#173634] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#789b96]">
                    info@n3uralia.com
                  </a>
                </li>
                <li>
                  <a href="https://wa.me/56993826127" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#173634] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#789b96]">
                    WhatsApp: +56 9 9382 6127
                  </a>
                </li>
                <li>
                  <a href="https://linkedin.com/company/n3uralia" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#173634] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#789b96]">
                    LinkedIn
                  </a>
                </li>
              </ul>
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#173634] px-5 py-3 text-sm font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#244946] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#789b96]"
              >
