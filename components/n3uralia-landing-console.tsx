...
const content: Record<Locale, { eyebrow: string; title: string; helper: string; stages: string[]; scenarios: ConsoleScenario[]; cta: string }> = {
  ...
  es: {
    ...
    title: 'Elige la friccion operativa. Mira el sistema que N3uralia construye alrededor.',
    helper: 'Partimos haciendo visibles las senales dispersas y las convertimos en flujos, agentes, tableros y seguimiento.',
    ...
    scenarios: [
      {
        ...
        after: 'Los equipos ven riesgo, estado y evidencia antes de que la operacion quede expuesta.',
      },
      {
        id: 'field',
        ...
        after: 'La operacion avanza con trazabilidad, escalamiento rapido y menos puntos ciegos.',
      },
      {
        id: 'agents',
        label: 'Agentes IA en produccion',
        metric: 'De prompts demo a trabajo util',
