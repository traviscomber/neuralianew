    ...
    sections: [
      {
        ...
        body: {
          es: "Ecosuelolab recibe alertas diarias de IrriWatch (Hydrosat): estrés hídrico, humedad de suelo y recomendaciones de riego. Antes, estas alertas llegaban dispersas y requerían validación y enrutamiento manual.",
          en: "Ecosuelolab receives daily IrriWatch (Hydrosat) alerts: water stress, soil moisture, and irrigation recommendations. Previously, alerts were scattered and required manual validation and routing.",
        },
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          { es: "Normalización + detección de intención", en: "Normalization + intent detection" },
